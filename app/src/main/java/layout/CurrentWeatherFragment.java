...
public class CurrentWeatherFragment extends Fragment {
    ...
    private CurrentWeatherR curWeather;
    ...
    public void setWeather(CurrentWeatherR curWeather) {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        textView = (TextView) getActivity().findViewById(R.id.current_temp);
//        if(curWeather != null) {
//            textView.setText(curWeather.getTemperature()+"");
//        }
